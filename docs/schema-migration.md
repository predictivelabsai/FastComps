...
|---|---|---|
| market_address_attempt | legacy_market_address_attempt | raw operational history |
...
| market_config | legacy_market_config | raw configuration |
| market_country_campaign | legacy_market_country_campaign | coverage_campaigns |
| market_geocode_cache | legacy_market_geocode_cache | raw geocode history |
| market_geocode_gate | legacy_market_geocode_gate | raw operational state |
...
| search_provider_credentials | legacy_search_provider_credentials | encrypted raw mirror only |
