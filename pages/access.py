...
def access_page(card, *, title: str, lang: str = "en"):
    return Html(
        Head(
            Meta(charset="utf-8"), Meta(name="viewport", content="width=device-width,initial-scale=1"),
            Meta(name="robots", content="noindex"), Title(f"{t(title, lang)} · FastComps"),
        ...
        Body(Div(language_switcher(lang), cls="auth-language"), card, cls="signin-body"),
        lang=lang,
    )
